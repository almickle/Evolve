...
class LessThanOrEqualNode : public ShaderNode {
public:
	LessThanOrEqualNode( const std::string& name = "LessThanOrEqualNode" )
		: ShaderNode( NodeTypes::LessThanOrEqual, 2, 1, 0, name )
	{
